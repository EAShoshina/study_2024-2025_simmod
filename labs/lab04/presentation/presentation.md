...
![Изменение размера окна TCP на линке 1-го источника при N=30](image/1.jpg){#fig:001 width=35%}

## 2. Построили графики изменения размера окна TCP и построили графики изменения длины очереди и средней длины очереди на первом маршрутизаторе в Xgraph.

![Изменение размера окна TCP на всех источниках при N=30](image/2.jpg){#fig:002 width=35%}

## 2. Построили графики изменения размера окна TCP и построили графики изменения длины очереди и средней длины очереди на первом маршрутизаторе в Xgraph.

![Изменение размера длины очереди на линке (R1–R2) при N=30, q_min = 75, q_max = 150](image/3.jpg){#fig:003 width=35%}

## 2. Построили графики изменения размера окна TCP и построили графики изменения длины очереди и средней длины очереди на первом маршрутизаторе в Xgraph.

![Изменение размера средней длины очереди на линке (R1–R2) при N=30, q_min = 75, q_max = 150](image/4.jpg){#fig:004 width=35%}
